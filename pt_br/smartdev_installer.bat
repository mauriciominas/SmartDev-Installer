...
REM   Verifica se o comando existe no sistema.
REM ============================================================
:WhereCheck
where %1 >nul 2>&1
exit /b %errorlevel%
...
REM   Registra o caminho do executavel no log.
REM ============================================================
:WhereLog
where %1 >> "%LOGFILE%" 2>&1
goto :eof
...
REM   Tenta upgrade; se nÃ£o instalado, faz install.
REM   Usa arquivo temporÃ¡rio para evitar falso positivo no log.
REM ============================================================
:Pkg
echo Verificando %2...
...
REM Verifica se o pacote nÃ£o estÃ¡ instalado
...
REM Verifica se jÃ¡ estÃ¡ na Ãºltima versÃ£o (EN + PT com substrings ASCII-safe)
...
REM ============================================================
REM :Python â€” Detecta alias da Microsoft Store e busca versÃ£o dinamicamente
REM ============================================================
:Python
...
REM ============================================================
REM :Java â€” Busca a versÃ£o mais recente do Temurin JDK dinamicamente
REM ============================================================
:Java
...
REM ============================================================
REM :Flutter â€” Instala ou exibe versÃ£o existente
REM ============================================================
:Flutter
...
REM ============================================================
REM :Supabase â€” Tenta winget, fallback para npm
REM ============================================================
:Supabase
...
REM Verifica versÃ£o apenas se o comando estiver disponÃ­vel
call :WhereCheck supabase
if not errorlevel 1 (
...
REM ============================================================
REM :AndroidSDK â€” Instala Android Command Line Tools
REM ============================================================
:AndroidSDK
...
REM ============================================================
REM :UpdateDev â€” Atualiza todos os componentes
REM ============================================================
:UpdateDev
echo.
...
REM ============================================================
REM :ConfigurePaths — Configura PATH e variaveis de ambiente
REM ============================================================
:ConfigurePaths
